...
import javax.swing.*;
/**
 * Krizec Krozec: Grafična različica za enega igralca
 */
@SuppressWarnings("serial")
public class KrizecKrozecGrafika1 extends JFrame {
   ...
   public static void main(String[] args) {
      ...
      SwingUtilities.invokeLater(new Runnable() {
         @Override
         public void run() {
            new KrizecKrozecGrafika1(); // Konstruktor naredi svoje delo
         }
      });
   }
}